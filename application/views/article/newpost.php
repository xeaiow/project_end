			...
			<div class="ui eight wide column">
	            <div class="ui form">
	                <div class="field" id="newpost-edit-content">
                        ...
                        <div contenteditable="plaintext-only" id="post-content" class="ui segment post-content scrollbar-black" ng-model="postContent"></div>
	                    <h2><i class="file image outline icon" id="newpost-select-pic"></i></h2>
	                </div>

	                <div class="field">
	                    <div class="ui toggle checkbox">
	                        <input type="checkbox" id="post-anonymous" ng-model="postAnonymous">
	                        <label for="post-anonymous">匿名</label>
	                    </div>
					</div>
					<div class="field">
	                    <div class="ui toggle checkbox">
                ...
                <form id="newpost-imgur" method="post" enctype="multipart/images">
