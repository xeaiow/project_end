...
*/
$route['default_controller'] = 'meet/start';
...
$route['meet/MatchKeywords/d3/query'] = 'meet/d3getMatchKeywords';
$route['meet/slefPlace/query'] = 'meet/getSelfPlace';
$route['place'] = 'meet/place';
$route['place/(:num)'] = 'meet/place/$1';
$route['meet/friends/save'] = 'meet/setFriends';
